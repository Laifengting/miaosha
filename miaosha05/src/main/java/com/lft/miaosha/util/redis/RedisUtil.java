package com.lft.miaosha.util.redis;
...
public class RedisUtil {
    private Logger log = Logger.getLogger("RedisUtil");
    @Autowired
     ...
     * @param key
     * @return 当 key 不存在时，返回 -2 。当 key 存在但没有设置剩余生存时间时，返回 -1 。否则，以秒为单位，返回 com.lft.miaosha
     * .common.key
     * 的剩余生存时间。 发生异常 返回 0
     */
